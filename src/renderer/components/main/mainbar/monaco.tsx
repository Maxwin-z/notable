...
import { initVimMode } from "../../../plugins/monaco-vim/index.js";
/* MONACO */
...
> {
  ...
  editorUpdateZone = (
    zone: "_zoneTitlebarId" | "_zonePaddingTopId",
    isActive: boolean,
    options: Partial<monaco.editor.IViewZone>
  ) => {
    if (!this.editor) return;
